# This Makefile is for the PGObject extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/PGObject.pm]
#     AUTHOR => [q[Chris Travers <chris.travers@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[PGObject]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Test::Exception=>q[0], DBD::Pg=>q[2] }
#     VERSION_FROM => q[lib/PGObject.pm]
#     clean => { FILES=>q[PGObject-*] }
...
TO_INST_PM = lib/PGObject.pm

PM_TO_BLIB = lib/PGObject.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/PGObject.pm $(INST_MAN3DIR)/PGObject.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''A toolkit integrating intelligent PostgreSQL dbs into Perl objects'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: PGObject' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  DBD::Pg: 2' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "A toolkit integrating intelligent PostgreSQL dbs into Perl objects",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "PGObject",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "DBD::Pg" : "2",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="1.2">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>A toolkit integrating intelligent PostgreSQL dbs into Perl objects</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Chris Travers &lt;chris.travers@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBD::Pg" VERSION="2" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/PGObject.pm blib/lib/PGObject.pm 
